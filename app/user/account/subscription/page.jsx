...
const AccountPage = () => {
  ...
  const updateSubscription = (subscription) => {
    updateUserSubscription({user_id: user.id, new_subscription_id: subscription.id}, token).then((response) => {
      console.log(response)
      Swal.fire({
        title: "Subscripción actualizada!",
        text: "Recuerda que el cambio de subscripción se verá reflejado en la siguiente factura. Asi mismo en la visualización del contenido.",      icon: "success",
